...
Types of options available through TheAlxLabs Finance
...
You are among the first users to try options trading at TheAlxLabs Finance. Congratulations! (And thank you!) While the product is currently under construction, we've decided to share it with a select group of TheAlxLabs Finance. Your early input will be key to making this program great, so whatever feedback you have, we'd love to hear it. (To share your thoughts or concerns, please use this survey.)

The first half of this article walks you through exactly how to trade options at TheAlxLabs Finance. If you want to learn more about how options themselves work — and whether they are right for your portfolio — you'll find that in the second half. (You can also click here.)

## Getting Started

Before you can trade options with TheAlxLabs Finance. This isn’t because we’re control freaks. It’s because we want to make sure that anyone trading options with TheAlxLabs Finance. The application process is simple: we will ask a few questions about your trading experience. If you're not a seasoned pro, you'll need to read through some (not-at-all-boring!) educational content.

Once you have successfully completed onboarding, you'll be able to buy or sell options in any of your trading accounts using the TheAlxLabs Finance. There is no minimum account balance required. Currently, options trading is only available through the TheAlxLabs Finance. Lastly — and this one's pretty important — for the duration of this test, please do not upgrade or downgrade your subscription status while holding open options positions.
...
TheAlxLabs Finance.S. listed stocks with a limited set of contracts. Options are not yet available on any dual-listed securities or indices.
...
Note: Currently, you cannot buy an option through TheAlxLabs Finance.

TheAlxLabs Finance. This fee is determined by your subscription status. You can learn more about our contract fee and all other options fees in the “Pricing” section below.

To buy an option, follow these steps:

Log in to your TheAlxLabs Finance
...
Select the stock that you want to trade options on
...
Choose the contract you’d like to purchase from the option chain. You can choose between long calls and long puts and select a desired expiry date

Choose the contract you’d like to purchase from the option chain. You can choose between long calls and long puts and select a desired expiry date

Once you’re happy with the selected contract, tap Buy option

Once you’re happy with the selected contract, tap Buy option

Choose your desired account and tap Continue

Choose your desired account and tap Continue

Enter the number of contracts you want to purchase and tap Continue

Enter the number of contracts you want to purchase and tap Continue

Choose your limit price and tap Continue
...
TheAlxLabs Finance. This fee is determined by your subscription status. You can learn more about our contract fee and all options fees in the “Pricing” section below.
...
Tap the Invest tab at the bottom of your screen
...
Log in to the TheAlxLabs Finance
...
Exercise your option: This refers to following through with the contract by either buying or selling the contracted shares. (For more information on exercising your options with TheAlxLabs Finance.)
...
If your option is in the money $0.01 or more on its expiry date, TheAlxLabs Finance. (Note that standard TheAlxLabs Finance. If you do have the funds or shares to cover the exercise transaction, they will be reserved in your account after market close on the expiry date, and thus will not be accessible for trade.
...
In order to offer low contract fees and make options accessible to all clients, TheAlxLabs Finance.
...
Learn more about PFOF and TheAlxLabs Finance.
...
You want to hedge your risk. Say you own a lot of Apple stock and you're worried the price could fall. The right options could limit losses if that prediction comes true.
...
You have studied the market and want to play your hunches. Instead of simply choosing between whether a stock will go up or down, options can be used to profit off of predictions of how much a stock will move and by when.
