...
Ali Perdue is the Manager of Margin Supervision at TheAlxLabs Finance. A Chartered Professional Accountant who earned her designation at KPMG, she brings extensive regulatory and operations experience from her previous roles as a Financial Operations Examiner at the Canadian Investment Regulatory Organization (CIRO). She also teaches accounting at the post-secondary level, combining practical industry expertise with educational leadership.

Pump-and-dump schemes create artificial buzz to inflate prices, which then collapse when the scheme’s insiders sell — leaving latecomer investors stuck with the losses. In today’s digital investment landscape, when online communities can shape markets in minutes, these schemes are becoming increasingly more common, and they’re able to implement the schemes faster which make them both quick-moving and risky.
